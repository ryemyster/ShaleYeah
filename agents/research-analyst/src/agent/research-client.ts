/**
 * Research MCP client — thin wrapper that connects to the research Tier 1 server over HTTP,
 ...
 * that may not run co-located with the research server at all times.
 *
...
export async function callResearchTool(
	...
	const callPromise = (async () => {
		...
		const client = new Client({ name: "research-analyst", version: "0.1.0" });
