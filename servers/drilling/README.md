...
Bartholomew Boreman — Drilling Engineer — one of the 14 specialist AI agents in the ShaleYeah deal team.
...
```json
{ "mcpServers": { "drilling": { "command": "pnpm", "args": ["--filter", "@shaleyeah/server-drilling", "start"] } } }
```
