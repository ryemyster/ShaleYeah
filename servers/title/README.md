...
Theophilus Titlesworth — Title Analyst — one of the 14 specialist AI agents in the ShaleYeah deal team.
...
```json
{ "mcpServers": { "title": { "command": "pnpm", "args": ["--filter", "@shaleyeah/server-title", "start"] } } }
```
