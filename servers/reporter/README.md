...
Horatio Penwright — Senior Reporter — one of the 14 specialist AI agents in the ShaleYeah deal team.
...
```json
{ "mcpServers": { "reporter": { "command": "pnpm", "args": ["--filter", "@shaleyeah/server-reporter", "start"] } } }
```
