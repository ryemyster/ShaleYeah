...
import { LASParser, type LASData } from './parsers/las-parser.js';
import { GISParser, type GISData } from './parsers/gis-parser.js';
import { ExcelParser, type ExcelData } from './parsers/excel-parser.js';
import { SEGYParser, type SEGYData } from './parsers/segy-parser.js';
...
export class FileIntegrationManager {
   ...
   */
  async validateFileCompatibility(filePath: string, expectedFormat: string): Promise<{
    compatible: boolean;
    confidence: number;
    issues: string[];
  }> {
